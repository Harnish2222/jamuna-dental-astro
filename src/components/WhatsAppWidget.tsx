...
const WHATSAPP_NUMBER = '917200620011';
const WHATSAPP_MESSAGE = 'Hello! I would like to enquire about your dental services.';
...
const WhatsAppWidget = () => {
  ...
  return (
    <>
      {/* Desktop: floating WhatsApp + Phone buttons */}
      {!isMobile && (
        <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-3">
          <a
            href={`tel:${PHONE}`}
            className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            aria-label="Call us"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
