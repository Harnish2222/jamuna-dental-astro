        ...
        fields: [
          {
            ...
            fields: [
              {
                type: "string",
                label: "Heading Part 1 (Black)",
                name: "heading_part1",
              },
              {
                type: "string",
                label: "Heading Part 2 (Blue)",
                name: "heading_part2",
              },
              ...
              },
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.text || "Highlight Item",
                  }),
                },
          ...
          },
          {
            ...
            fields: [
              ...
              {
                type: "string",
                label: "CTA Button Text (Primary)",
                name: "cta_text",
              },
              {
                type: "string",
                label: "CTA Button Text (Secondary)",
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.label || "Treatment Category",
                  }),
                },
                fields: [
                  ...
                  { type: "image", label: "Feature Image", name: "image" },
                  {
                    ...
                    ui: {
                      itemProps: (item: any) => ({
                        label: item?.name || "Service Price Item",
                      }),
                    },
                    fields: [
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.title || "Transformation Item",
                  }),
                },
                fields: [
                  { type: "string", label: "Title", name: "title" },
                  ...
                  {
                    type: "image",
                    label: "Transformation Image (Combined Before/After)",
                    name: "image",
                  },
                ],
              },
            ...
            fields: [
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.alt || item?.src || "Carousel Image",
                  }),
                },
                fields: [
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "image", label: "Image", name: "image" },
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.label || item?.value || "Stat Item",
                  }),
                },
                fields: [
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.alt || item?.src || "Clinic Image",
                  }),
                },
                fields: [
                  { type: "image", label: "Image", name: "src" },
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                ui: {
                  itemProps: (item: any) => ({
                    label: item?.alt || item?.src || "Gallery Image",
                  }),
                },
                fields: [
                  { type: "image", label: "Image", name: "src" },
